...
public:
	...
	enum Flags2 {
		kFlag_kNone = 0,
		kFlag_kScenePackage = 1 << 0,
		kFlag_kIsAMount = 1 << 1,
		kFlag_kMountPointClear = 1 << 2,
		kFlag_kGettingOnOffMount = 1 << 3,
		kFlag_kInRandomScene = 1 << 4,
		kFlag_kNoBleedoutRecovery = 1 << 5,
		kFlag_kInBleedoutAnimation = 1 << 6,
		kFlag_kCanDoFavor = 1 << 7,
		kFlag_kShouldAnimGraphUpdate = 1 << 8,
		kFlag_kCanSpeakToEssentialDown = 1 << 9,
		kFlag_kBribedByPlayer = 1 << 10,
		kFlag_kAngryWithPlayer = 1 << 11,
		kFlag_kIsTrespassing = 1 << 12,
		kFlag_kCanSpeak = 1 << 13,
		kFlag_kIsInKillMove = 1 << 14,
		kFlag_kAttackOnSight = 1 << 15,
		kFlag_kIsCommandedActor = 1 << 16,
		kFlag_kForceOneAnimgraphUpdate = 1 << 17,
		kFlag_kEssential = 1 << 18,
		kFlag_kProtected = 1 << 19,
		kFlag_kAttackingDisabled = 1 << 20,
		kFlag_kCastingDisabled = 1 << 21,
		kFlag_kSceneHeadTrackRotation = 1 << 22,
		kFlag_kForceIncMinBoneUpdate = 1 << 23,
		kFlag_kCrimeSearch = 1 << 24,
		kFlag_kMovingIntoLoadedArea = 1 << 25,
		kFlag_kDoNotShowOnStealthMeter = 1 << 26,
		kFlag_kMovementBlocked = 1 << 27,
		kFlag_kAllowInstantFurniturePopInPlayerCell = 1 << 28,
		kFlag_kForceAnimGraphUpdate = 1 << 29,
		kFlag_kCheckAddEffectDualCast = 1 << 30,
...
public:
	...
	UInt64						unk3E0;								// 3E0
	UInt32						unk3E8;								// 3E8
	NiAVObjectPtr				nodeList[kNode_Num];					// 3F0
	UInt64						unk530;								// 530
	...
	UInt32			targetHandle;
	UInt64						unk10B8[(0x11F8 - 0x10B9) >> 3];	// 11F8
	UInt32						unk11F8;
	UInt8						unk11FC;
...
STATIC_ASSERT(offsetof(PlayerCharacter, nodeList) == 0x3F0);
